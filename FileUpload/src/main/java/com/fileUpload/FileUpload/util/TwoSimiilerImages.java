...
public class TwoSimiilerImages {
	...
	public TwoSimiilerImages(String file1, String file2) throws IOException {
	...
	public void setParameters(int compareX, int compareY) {
		TwoSimiilerImages.compareX = compareX;
		TwoSimiilerImages.compareY = compareY;
	}
	...
	public void compare() {
		...
		TwoSimiilerImages.isIdentic = true;
